    ...
    return (
        <nav className='bg-blue-700'>
                ...
                <div className='flex justify-between '>
                    <div className='flex space-x-4'>
                        ...
                        <div className='hidden md:flex items-center space-x-1'>
                            <a href='https://github.com/Dev-Spaces' className='py-5 px-3 text-white hover:text-gray-400'>GitHub</a>
                            <a href='https://www.misiontic2022.gov.co/portal/' className='py-5 px-3 text-white hover:text-gray-400'>MisionTic</a>
                        </div>
                    </div>
            ...
            <div className='mobile-menu hidden md:hidden'>
                <a href="https://github.com/Dev-Spaces" className='block py-2 px-4 text-sm hover:bg-blue-300 rounded'>GitHub</a>
